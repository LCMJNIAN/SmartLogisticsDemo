...
<div>
  ...
  <div class="job_two">
    <div v-for="item in list.slice((currentPage-1)*pagesize,currentPage*pagesize)" :key="item" class="offers">
      <a :href="item.jobs_address" target="_blank">
        <div class="first">
        <a :href="item.jobs_address" class="job_name">{{item.job_name}}</a>
        <span class="date_two">{{item.date}}</span>
        <a :href="item.company_address" class="company_name">{{item.company_name}}</a>
        </div>
        <div class="second">
        <span class="salary">{{item.salary}}</span>
        <span class="job_description">{{item.job_description}}</span>
        <span class="company_type">{{item.company_type}}|{{item.company_size}}</span>
        </div>
        <div class="second">
